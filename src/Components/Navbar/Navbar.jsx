  ...
  return (
    <div className='navbar'>
      ...
      <ul className='nav-menu'>
        ...
        <li><AnchorLink className='anchor-link' offset={20} href='#services'><p onClick={()=>setMenu("services")}>Services</p></AnchorLink>{menu==="services"}</li>
        <li><AnchorLink className='anchor-link' offset={20} href='#work'><p onClick={()=>setMenu("work")}>Portfolio</p></AnchorLink>{menu==="work"}</li>
